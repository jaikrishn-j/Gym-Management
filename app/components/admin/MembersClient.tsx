    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--accent)]/10 text-[var(--accent)] font-semibold text-sm">
                ...
                <motion.tr key={member.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }}
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      {member.imageUrl ? (
                        ...
                        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent)]/10 text-[var(--accent)] font-semibold text-xs">
                  ...
                  <td className="px-4 py-3 text-right">
                    <button onClick={() => handleViewMember(member)}
                      className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[var(--accent)] text-[var(--accent-foreground)] hover:bg-[var(--accent)]/90 font-medium text-xs transition-colors">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  {selectedMember.imageUrl ? (
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent)]/10 text-[var(--accent)] font-semibold text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      {markAttendance && (
                        <button onClick={() => setShowMarkAttendance(!showMarkAttendance)}
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--accent)] text-[var(--accent-foreground)] text-xs font-semibold">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <input type="date" value={attendanceForm.date}
                              ...
                              className="w-full h-10 px-3 rounded-xl border border-[var(--field-border)] bg-[var(--field-background)] text-sm outline-none focus:border-[var(--accent)]" />
                          </div>
                          <div>
                  ...
                  <div className="space-y-2">
                    {availablePlans.filter(p => p.isActive).map((plan) => (
                      <motion.button key={plan.id} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}
                        ...
                        className="w-full text-left p-3.5 rounded-xl border border-[var(--border)] hover:border-[var(--accent)] bg-[var(--field-background)] transition-all">
                        <div className="flex items-center justify-between">
                          <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input type="number" value={paymentForm.amount}
                    ...
                    className="w-full h-12 px-4 rounded-xl border border-[var(--field-border)] bg-[var(--field-background)] text-[var(--foreground)] font-bold text-lg outline-none focus:border-[var(--accent)]" />
                </div>
                ...
                <div>
                  ...
                  <input type="text" value={paymentForm.notes}
                    ...
                    className="w-full h-12 px-4 rounded-xl border border-[var(--field-border)] bg-[var(--field-background)] text-[var(--foreground)] text-sm outline-none focus:border-[var(--accent)]" />
                </div>
                ...
                <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
                  ...
                  className="w-full h-12 rounded-xl bg-[var(--accent)] text-[var(--accent-foreground)] font-bold shadow-lg shadow-[var(--accent)]/20 disabled:opacity-50 flex items-center justify-center gap-2">
